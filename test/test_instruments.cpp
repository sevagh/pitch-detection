...
{
	auto data = test_util::vec_from_file<float>("./misc/samples/A4_44100_violin.txt");
...
{
	auto data = test_util::vec_from_file<float>("./misc/samples/B4_44100_piano.txt");
	float pitch = pitch::yin<float>(data, 44100);
...
{
	auto data = test_util::vec_from_file<float>("./misc/samples/D4_44100_piano.txt");
	float pitch = pitch::yin<float>(data, 44100);
...
{
	auto data =
	    test_util::vec_from_file<float>("./misc/samples/E2_44100_acousticguitar.txt");
	float pitch = pitch::yin<float>(data, 44100);
...
{
	auto data = test_util::vec_from_file<double>("./misc/samples/A4_44100_violin.txt");
...
{
	auto data = test_util::vec_from_file<double>("./misc/samples/B4_44100_piano.txt");
	float pitch = pitch::yin<double>(data, 44100);
	float expected = 493.9;
	EXPECT_NEAR(expected, pitch, 0.01 * expected);
}
...
{
	auto data = test_util::vec_from_file<double>("./misc/samples/D4_44100_piano.txt");
	float pitch = pitch::yin<double>(data, 44100);
	float expected = 293.7;
	EXPECT_NEAR(expected, pitch, 0.01 * expected);
}
...
{
	auto data =
	    test_util::vec_from_file<double>("./misc/samples/E2_44100_acousticguitar.txt");
	float pitch = pitch::yin<double>(data, 44100);
	float expected = 82.41;
	EXPECT_NEAR(expected, pitch, 0.01 * expected);
}
